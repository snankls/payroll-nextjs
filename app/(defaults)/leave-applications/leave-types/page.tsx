            ...
            <div className="invoice-table">
                <div className="mb-4.5 flex flex-col gap-5 px-5 md:flex-row md:items-center">
                    <div className="flex items-center gap-2">
                        ...
                        {/* <Link href="/leave-applications/setup" className="btn btn-primary gap-2">
                            <IconPlus />
                            Add New
                        </Link> */}
                    </div>
                        ...
                        >
                            <DialogPanel as="div" className="panel my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                <div className="flex items-center justify-between bg-[#fbfbfb] px-5 py-3 dark:bg-[#121c2c]">
                                    <div className="text-lg font-bold">Leave Type Add/Edit</div>
                                ...
                                <div className="p-5">
                                    <form>
                                        <fieldset className="grid grid-cols-1 items-end gap-4 md:grid-cols-1">
                                            <div>
                                                <label className="text-white-dark">Type Name</label>
