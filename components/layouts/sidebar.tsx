                        ...
                        <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'employee' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('employee')}>
                                    <div className="flex items-center">
                                        <IconMenuWidgets className="shrink-0 group-hover:!text-primary" />
                                        <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Employees</span>
                                    </div>

                                    <div className={currentMenu !== 'employee' ? '-rotate-90 rtl:rotate-90' : ''}>
                                        <IconCaretDown />
                                    </div>
                                </button>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'organization' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('organization')}>
                                    ...
                                    <div className={currentMenu !== 'organization' ? '-rotate-90 rtl:rotate-90' : ''}>
                                        <IconCaretDown />
                                    </div>
                                </button>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'attendance' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('attendance')}>
                                    <div className="flex items-center">
                                        <IconMenuCalendar className="shrink-0 group-hover:!text-primary" />
                                        <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Attendances</span>
                                    </div>

                                    <div className={currentMenu !== 'attendance' ? '-rotate-90 rtl:rotate-90' : ''}>
                                        <IconCaretDown />
                                    </div>
                                </button>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'leave' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('leave')}>
                                    <div className="flex items-center">
                                        <IconMenuForms className="shrink-0 group-hover:!text-primary" />
                                        <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Leave Applications</span>
                                    </div>
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'leave' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        ...
                                        <li>
                                            <Link href="/leave-applications/leave-types">Leave Type</Link>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
